...
class setData():
    ...
    def _validate_value(self, msg, data_type, min_value = None, max_value = None, collection = None):
        ...
        if collection != None:
                self._validate_collection_value(msg, data_type, min_value, max_value, collection)
        elif data_type == str:
    ...
    def _validate_collection_value(self, msg, data_type, min_value = None, max_value = None, collection = None):
    ...
    def process_vehicle_topic(self, client, userdata, msg):
        ...
        if re.search("^openWB/set/vehicle/[0-9]+/name$", msg.topic) != None:
            ...
            self._validate_value(msg, int, min_value=0, max_value=1)
            ...
            self._validate_value(msg, int, min_value=1)
            ...
            self._validate_value(msg, int, min_value=6, max_value=32)
    ...
    def _subprocess_vehicle_chargemode_topic(self, msg):
        ...
        if re.search("^openWB/set/vehicle/template/charge_template/[1-9][0-9]*/name$", msg.topic) != None:
            ...
            self._validate_value(msg, int, min_value=2, max_value=100)
            ...
            self._validate_value(msg, int, min_value=0, max_value=1, collection=list)
            ...
            self._validate_value(msg, int, min_value=4, max_value=15)
        else:
            log.message_debug_log("error", "Unbekanntes set-Topic: "+str(msg.topic)+", "+ str(json.loads(str(msg.payload.decode("utf-8")))))
    ...
    def process_chargepoint_topic(self, client, userdata, msg):
        ...
        if (re.search("^openWB/set/chargepoint/get/counter_all$", msg.topic) != None or
            ...
            self._validate_value(msg, float, min_value=6, max_value=32)
            ...
            self._validate_value(msg, int, min_value=0, max_value=4)
            ...
            self._validate_value(msg, int, min_value=6, max_value=32)
        elif re.search("^openWB/set/chargepoint/[1-9][0-9]*/config/connected_phases", msg.topic) != None:
            self._validate_value(msg, int, min_value=1, max_value=3)
            ...
            self._validate_value(msg, float, min_value=0, collection=list)
            ...
            self._validate_value(msg, int, min_value=0, max_value=2)
        elif (re.search("^openWB/set/vehicle/[0-9]+/soc/get/fault_str$", msg.topic) != None or
                re.search("^openWB/set/vehicle/[0-9]+/soc/get/state_str$", msg.topic) != None or
                re.search("^openWB/set/vehicle/[0-9]+/soc/get/plug_time$", msg.topic) != None or
                re.search("^openWB/set/vehicle/[0-9]+/soc/get/heartbeat$", msg.topic) != None):
            self._validate_value(msg, str)
    ...
    def process_pv_topic(self, client, userdata, msg):
        ...
        if re.search("^openWB/set/pv/config/configured$", msg.topic) != None:
            self._validate_value(msg, int, min_value=0, max_value=1)
        elif (re.search("^openWB/set/pv/config/feed_in_yield$", msg.topic) != None or 
                re.search("^openWB/set/pv/config/switch_on_threshold$", msg.topic) != None or
                re.search("^openWB/set/pv/config/switch_on_delay$", msg.topic) != None or
                re.search("^openWB/set/pv/config/switch_off_threshold$", msg.topic) != None or
                re.search("^openWB/set/pv/config/switch_off_delay$", msg.topic) != None):
            self._validate_value(msg, int, min_value=0)
        elif re.search("^openWB/set/pv/config/phase_switch_delay$", msg.topic) != None:
            self._validate_value(msg, int, min_value=1, max_value=15)
        elif re.search("^openWB/set/pv/config/control_range$", msg.topic) != None:
            ...
            self._validate_value(msg, float, min_value=0, collection=list)
        elif re.search("^openWB/set/pv/get/overhang_power_left$", msg.topic) != None:
    ...
    def process_general_topic(self, client, userdata, msg):
        ...
        if re.search("^openWB/set/general/extern$", msg.topic) != None:
            ...
            self._validate_value(msg, int, min_value=10, max_value=60)
        elif re.search("^openWB/set/general/external_buttons_hw$", msg.topic) != None:
            self._validate_value(msg, int, min_value=0, max_value=1)
        elif re.search("^openWB/set/general/chargemode/individual_mode$", msg.topic) != None:
            self._validate_value(msg, int, min_value=0, max_value=1)
        elif re.search("^openWB/set/general/chargemode/unbalanced_load$", msg.topic) != None:
            self._validate_value(msg, int, min_value=0, max_value=1)
        elif re.search("^openWB/set/general/chargemode/unbalanced_load_limit$", msg.topic) != None:
            self._validate_value(msg, int, min_value=10, max_value=32)

        if re.search("^openWB/set/general/chargemode/pv_charging/feed_in_yield_active$", msg.topic) != None:
            self._validate_value(msg, int, min_value=0, max_value=1)
        elif (re.search("^openWB/set/general/chargemode/pv_charging/feed_in_yield$", msg.topic) != None or 
                re.search("^openWB/set/general/chargemode/pv_charging/switch_on_threshold$", msg.topic) != None or
                re.search("^openWB/set/general/chargemode/pv_charging/switch_on_delay$", msg.topic) != None or
                re.search("^openWB/set/general/chargemode/pv_charging/switch_off_threshold$", msg.topic) != None or
                re.search("^openWB/set/general/chargemode/pv_charging/switch_off_delay$", msg.topic) != None):
            self._validate_value(msg, int, min_value=0)
        elif re.search("^openWB/set/general/chargemode/pv_charging/phase_switch_delay$", msg.topic) != None:
            self._validate_value(msg, int, min_value=1, max_value=15)
        elif re.search("^openWB/set/general/chargemode/pv_charging/control_range$", msg.topic) != None:
            self._validate_value(msg, int, collection=list)
        elif re.search("^openWB/set/general/chargemode/pv_charging/phases_to_use$", msg.topic) != None:
            self._validate_value(msg, int, min_value=1, max_value=3)
            self._validate_value(msg, str)
        elif re.search("^openWB/set/general/chargemode/[a-z,_]+/phases_to_use$", msg.topic) != None:
            self._validate_value(msg, int, min_value=1, max_value=3)
            ...
            self._validate_value(msg, float, min_value=0, max_value=99.99)
        else:
            log.message_debug_log("error", "Unbekanntes set-Topic: "+str(msg.topic)+", "+ str(json.loads(str(msg.payload.decode("utf-8")))))
    ...
    def process_optional_topic(self, client, userdata, msg):
        ...
        if re.search("^openWB/set/optional/load_sharing/active$", msg.topic) != None:
            ...
            self._validate_value(msg, int, min_value=16, max_value=32)
    ...
    def process_counter_topic(self, client, userdata, msg):
        ...
        if re.search("^openWB/set/counter/set/loadmanagement$", msg.topic) != None:
            self._validate_value(msg, int, min_value=0, max_value=1)
        elif re.search("^openWB/set/counter/set/consumption_left$", msg.topic) != None:
            self._validate_value(msg, float, min_value=0)
        elif re.search("^openWB/set/counter/set/current_left$", msg.topic) != None:
            self._validate_value(msg, float, min_value=0, collection=list)
