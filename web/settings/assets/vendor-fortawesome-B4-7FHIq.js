import{g as ln,d as Ga,c as N,h as J,w as Ze}from"./vendor-sTaGx5iS.js";function Na(a,n){(n==null||n>a.length)&&(n=a.length);for(var e=0,t=Array(n);e<n;e++)t[e]=a[e];return t}function at(a){if(Array.isArray(a))return a}function nt(a){if(Array.isArray(a))return Na(a)}function et(a,n){if(!(a instanceof n))throw new TypeError("Cannot call a class as a function")}function tt(a,n){for(var e=0;e<n.length;e++){var t=n[e];t.enumerable=t.enumerable||!1,t.configurable=!0,"value"in t&&(t.writable=!0),Object.defineProperty(a,Wn(t.key),t)}}function rt(a,n,e){return n&&tt(a.prototype,n),Object.defineProperty(a,"prototype",{writable:!1}),a}function fa(a,n){var e=typeof Symbol<"u"&&a[Symbol.iterator]||a["@@iterator"];if(!e){if(Array.isArray(a)||(e=Ha(a))||n){e&&(a=e);var t=0,r=function(){};return{s:r,n:function(){return t>=a.length?{done:!0}:{done:!1,value:a[t++]}},e:function(s){throw s},f:r}}throw new TypeError(`Invalid attempt to iterate non-iterable instance.
