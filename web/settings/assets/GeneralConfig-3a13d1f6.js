import{C as f}from"./index-0c650af4.js";import{_ as h,p as r,k as l,l as u,q as i,A as o,L as s,z as b,u as a}from"./vendor-b2608652.js";import"./vendor-fortawesome-899f0c22.js";import"./vendor-bootstrap-592d3051.js";import"./vendor-jquery-41c124d7.js";import"./vendor-axios-c1e37025.js";import"./vendor-sortablejs-66fb77ae.js";const v={name:"OpenwbGeneralConfig",mixins:[f],data(){return{mqttTopicsToSubscribe:["openWB/general/extern","openWB/general/extern_display_mode","openWB/general/control_interval","openWB/general/grid_protection_configured","openWB/general/external_buttons_hw","openWB/general/notifications/selected","openWB/general/notifications/configuration","openWB/general/notifications/start_charging","openWB/general/notifications/stop_charging","openWB/general/notifications/plug","openWB/general/notifications/smart_home","openWB/general/price_kwh","openWB/general/range_unit"]}}},B={class:"generalConfig"},_={name:"generalConfigForm"},w=i("br",null,null,-1),W=i("br",null,null,-1),k=i("br",null,null,-1),z=i("a",{href:"https://openwb.de/main/?page_id=1025",target:"_blank",rel:"noopener noreferrer"}," Homepage ",-1),$={key:0},S={key:1},x=i("br",null,null,-1),V=i("span",{class:"text-danger"},' Nicht nur die Regelung der PV geführten Ladung, sondern auch die Ladestromänderung, beispielsweise “Stop“ etc., werden dann nur noch in diesem Intervall ausgeführt. Die Regelung wird insgesamt träger. Solange es keinen triftigen Grund gibt, sollte "Normal" gewählt werden. ',-1),y=i("br",null,null,-1),q=i("span",{class:"text-danger"}," Die Option ist nur aktiv, wenn der EVU-Zähler die Frequenz übermittelt. ",-1),L={key:0},P={key:1},N=i("br",null,null,-1);function A(e,t,D,E,T,I){const p=r("openwb-base-alert"),d=r("openwb-base-button-group-input"),g=r("openwb-base-card"),m=r("openwb-base-number-input"),c=r("openwb-base-submit-buttons");return l(),u("div",B,[i("form",_,[o(g,{title:"Betriebsmodus"},{default:s(()=>[o(p,{subtype:"info"},{default:s(()=>[a(' Wird für den Steuerungsmodus "primary" gewählt, übernimmt diese openWB die alleinige Regelung und steuert ggf. vorhandene weitere openWB (z.B. externe openWB im Steuermodus secondary, openWB Pro, Satellit u.a.) fern. Sie werden in den Ladepunkt-Einstellungen der primary-openWB hinzugefügt. '),w,W,a(' Wird für den Steuerungsmodus "secondary" gewählt, übernimmt diese openWB keine Regelung und muss von einer anderen primary openWB ferngesteuert werden. Wichtig ist, dass in der secondary-openWB eine "interne openWB" mit der korrekten Bauart (= openWB-Hardwarevariante z.B. "Custom, Standard, Standard+, Duo, Buchse") konfiguriert ist. Bei einer Duo sind zwei "interne openWB" zu konfigurieren. Im "secondary"-Modus bleiben alle ausgeblendeten Einstellungen unbeachtet.'),k,a(" Eine bebilderte Anleitung zur Konfiguration der Ladepunkte findest Du auf der "),z,a(". ")]),_:1}),o(d,{title:"Steuerungsmodus",buttons:[{buttonValue:!1,text:"primary",class:"btn-outline-danger"},{buttonValue:!0,text:"secondary",class:"btn-outline-success"}],"model-value":e.$store.state.mqtt["openWB/general/extern"],"onUpdate:modelValue":t[0]||(t[0]=n=>e.updateState("openWB/general/extern",n))},null,8,["model-value"]),b(` <openwb-base-select-input
			...
			</openwb-base-card> `),o(g,{title:"Lade-Log"},{default:s(()=>[e.$store.state.mqtt["openWB/general/extern"]===!0?(l(),u("div",L,[o(p,{subtype:"info"},{default:s(()=>[a(' Diese Einstellungen sind nicht verfügbar, solange sich diese openWB im Modus "Nur Ladepunkt" befindet. ')]),_:1})])):(l(),u("div",P,[o(m,{title:"Preis je kWh",min:0,step:1e-4,unit:"€","model-value":e.$store.state.mqtt["openWB/general/price_kwh"],"onUpdate:modelValue":t[3]||(t[3]=n=>e.updateState("openWB/general/price_kwh",n))},{help:s(()=>[a(" Dient zur Berechnung der Ladekosten im Lade-Log."),N,a(" Es können bis zu 4 Nachkommastellen genutzt werden. ")]),_:1},8,["model-value"]),o(d,{title:"Einheit für Entfernungen","model-value":e.$store.state.mqtt["openWB/general/range_unit"],"onUpdate:modelValue":t[4]||(t[4]=n=>e.updateState("openWB/general/range_unit",n)),buttons:[{buttonValue:"km",text:"Kilometer"},{buttonValue:"mi",text:"Meilen"}]},null,8,["model-value"])]))]),_:1}),o(c,{formName:"generalConfigForm",onSave:t[5]||(t[5]=n=>e.$emit("save")),onReset:t[6]||(t[6]=n=>e.$emit("reset")),onDefaults:t[7]||(t[7]=n=>e.$emit("defaults"))})])])}const U=h(v,[["render",A],["__file","/opt/openWB-dev/openwb-ui-settings/src/views/GeneralConfig.vue"]]);export{U as default};
