...
<html lang="de">
	...
	<body>
		<div id="app">
			<content title="Einstellungen Sofortladen" footer="Sofortladen">

				<card title="Phasenumschaltung">
					<buttongroup-input
						title="Anzahl Phasen"
						ref="openWB/general/chargemode_config/instant_charging/phases_to_use"
						:buttons="[
		...
		<script>
			$.get(
				...
				function(data){
					...
					$('#navInstantCharge').addClass('disabled');
				}
			);
		</script>
