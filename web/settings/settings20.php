...
<html lang="de">
	<head>
		...
		<!-- load topics -->
		<script src = "settings/topicsToSubscribe_settings20.js?ver=20210712" ></script>
		<!-- load service -->
	...
	<body>
				...
				<div id="content">
					...
					<form id="myForm">
						...
						<div class="card border-secondary">
							...
							<div class="card-body notificationsOn">
							</div>
						</div>
		...
		<script>
			...
			function visibility(element) {
				...
				// 	if($(element).data('ontoggle')){
				// 		showSection($(element).data('ontoggle'));
				// 	}
				// 	if($(element).data('offtoggle')){
				// 		hideSection($(element).data('offtoggle'));
				// 	}
				// } else {
				// 	if($(element).data('ontoggle')){
				// 		hideSection($(element).data('ontoggle'));
				// 	}
				// 	if($(element).data('offtoggle')){
				// 		showSection($(element).data('offtoggle'));
				// 	}
				// }
			}
