...
def pub_settings():
    ...
    pub.pub("openWB/vehicle/template/charge_template/2/time_charging/1/time", ["08:00", "11:20"])
    pub.pub("openWB/vehicle/template/charge_template/2/time_charging/1/current", 10)
