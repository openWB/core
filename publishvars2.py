...
def pub_settings():
    ...
    pub.pub("openWB/vehicle/template/charge_template/1/chargemode/selected", "scheduled_charging")
    pub.pub("openWB/vehicle/template/charge_template/1/chargemode/pv_charging/min_current", 12)
