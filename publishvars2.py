...
def pub_settings():
    ...
    pub.pub("openWB/vehicle/template/charge_template/1/chargemode/instant_charging/current", 10)
    ...
    #ct2
    pub.pub("openWB/vehicle/template/charge_template/2/prio", 0)
    ...
    pub.pub("openWB/vehicle/template/charge_template/2/chargemode/pv_charging/feed_in_limit", 0)
