...
def pub_settings():
    ...
    #ev3
    pub.pub("openWB/vehicle/3/charge_template", 1)
    ...
    pub.pub("openWB/vehicle/template/charge_template/1/chargemode/scheduled_charging/1/time", "11:00")
    ...
    pub.pub("openWB/vehicle/template/charge_template/2/chargemode/selected", "scheduled_charging")
    ...
    pub.pub("openWB/vehicle/template/charge_template/3/chargemode/selected", "scheduled_charging")
