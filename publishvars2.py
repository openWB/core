...
def pub_settings():
    ...
    pub.pub("openWB/chargepoint/1/config/control_pilot_interruption_hw", 1)
    ...
    pub.pub("openWB/vehicle/1/soc/config/configured", 1)
    pub.pub("openWB/vehicle/1/soc/config/manual", 0)
    ...
    pub.pub("openWB/vehicle/2/soc/config/configured", 1)
    pub.pub("openWB/vehicle/2/soc/config/manual", 0)
    ...
    pub.pub("openWB/vehicle/3/soc/config/configured", 1)
    pub.pub("openWB/vehicle/3/soc/config/manual", 0)
    ...
    pub.pub("openWB/vehicle/template/ev_template/1/control_pilot_interruption", 0)
    #ct1
    ...
    pub.pub("openWB/vehicle/template/charge_template/1/time_charging/1/active", 0)
    ...
    pub.pub("openWB/vehicle/template/charge_template/1/chargemode/pv_charging/min_soc", 5)
    ...
    #ct3
    pub.pub("openWB/vehicle/template/charge_template/3/prio", 0)
    pub.pub("openWB/vehicle/template/charge_template/3/time_charging/active", 0)
    pub.pub("openWB/vehicle/template/charge_template/3/time_charging/1/active", 0)
    ...
    pub.pub("openWB/vehicle/template/charge_template/3/chargemode/pv_charging/feed_in_limit", 0)
    ...
    pub.pub("openWB/bat/config/configured", 0)
    ...
    pub.pub("openWB/general/range_unit", 0)
