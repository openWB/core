...
class UpdateConfig:
    valid_topic = ["^openWB/bat/config/configured$",
                   ...
                   "^openWB/bat/get/daily_yield_exported$",
                   "^openWB/bat/get/daily_yield_imported$",
                   "^openWB/bat/[0-9]+/get/soc$",
                   "^openWB/bat/[0-9]+/get/power$",
                   "^openWB/bat/[0-9]+/get/imported$",
                   "^openWB/bat/[0-9]+/get/exported$",
                   "^openWB/bat/[0-9]+/get/daily_yield_exported$",
                   "^openWB/bat/[0-9]+/get/daily_yield_imported$",
                   ...
                   "^openWB/counter/[0-9]+/get/daily_yield_exported$",
                   "^openWB/counter/[0-9]+/get/daily_yield_imported$",
