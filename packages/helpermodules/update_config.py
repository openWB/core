...
class UpdateConfig:
    valid_topic = ["^openWB/bat/config/configured$",
                   ...
                   "^openWB/command/max_id/chargepoint$",
                   ...
                   "^openWB/counter/0/get/voltage$",
                   "^openWB/counter/0/get/power_all$",
                   "^openWB/counter/0/get/current$",
                   "^openWB/counter/0/get/power_phase$",
                   "^openWB/counter/0/get/power_factor$",
                   "^openWB/counter/0/get/fault_state$",
                   "^openWB/counter/0/get/fault_str$",
                   "^openWB/counter/0/get/frequency$",
                   "^openWB/counter/0/get/daily_yield_export$",
                   "^openWB/counter/0/get/daily_yield_import$",
                   "^openWB/counter/0/get/imported$",
                   ...
                   "^openWB/system/device/0/component/0/simulation/timestamp_present$",
                   "^openWB/system/device/0/component/0/simulation/power_present$",
                   "^openWB/system/device/0/component/0/simulation/present_imported$",
                   "^openWB/system/device/0/component/0/simulation/present_exported$",
    ...
    default_topic = (
        ...
        ("openWB/set/general/chargemode_config/instant_charging/phases_to_use", 1),
        ("openWB/set/general/chargemode_config/pv_charging/bat_prio", 1),
        ("openWB/set/general/chargemode_config/pv_charging/switch_on_soc", 60),
        ("openWB/set/general/chargemode_config/pv_charging/switch_off_soc", 40),
        ("openWB/set/general/chargemode_config/pv_charging/rundown_power", 1000),
        ("openWB/set/general/chargemode_config/pv_charging/rundown_soc", 50),
        ("openWB/set/general/chargemode_config/pv_charging/charging_power_reserve", 200),
        ("openWB/set/general/chargemode_config/pv_charging/control_range", [0, 230]),
        ("openWB/set/general/chargemode_config/pv_charging/switch_off_threshold", 5),
        ("openWB/set/general/chargemode_config/pv_charging/switch_off_delay", 60),
        ("openWB/set/general/chargemode_config/pv_charging/switch_on_delay", 30),
        ("openWB/set/general/chargemode_config/pv_charging/switch_on_threshold", 1500),
        ("openWB/set/general/chargemode_config/pv_charging/feed_in_yield", 15000),
        ("openWB/set/general/chargemode_config/pv_charging/phase_switch_delay", 7),
        ("openWB/set/general/chargemode_config/pv_charging/phases_to_use", 1),
        ("openWB/set/general/chargemode_config/scheduled_charging/phases_to_use", 0),
        ("openWB/set/general/chargemode_config/standby/phases_to_use", 1),
        ("openWB/set/general/chargemode_config/stop/phases_to_use", 1),
        ("openWB/set/general/chargemode_config/time_charging/phases_to_use", 1),
        ...
        ("openWB/set/general/notifications/start_charging", False),
        ("openWB/set/general/notifications/stop_charging", False),
        ("openWB/set/general/notifications/smart_home", False),
        ("openWB/set/general/notifications/configuration", {}),
        ("openWB/set/general/price_kwh", 0.3),
        ("openWB/set/general/range_unit", "km"),
        ("openWB/set/general/ripple_control_receiver/configured", True),
        ("openWB/set/graph/config/duration", 60),
        ("openWB/set/optional/et/active", False),
        ("openWB/set/optional/et/config/max_price", 0),
        ...
        ("openWB/set/optional/rfid/active", False)
    )
