...
class UpdateConfig:
    valid_topic = ["^openWB/bat/config/configured$",
                   ...
                   "^openWB/bat/[0-9]+/get/simulation/timestamp_present$",
                   "^openWB/bat/[0-9]+/get/simulation/power_present$",
                   "^openWB/bat/[0-9]+/get/simulation/present_imported$",
                   ...
                   "^openWB/counter/[0-9]+/get/voltage$",
                   "^openWB/counter/[0-9]+/get/power_all$",
                   "^openWB/counter/[0-9]+/get/current$",
                   ...
                   "^openWB/counter/[0-9]+/get/simulation/timestamp_present$",
                   "^openWB/counter/[0-9]+/get/simulation/power_present$",
                   "^openWB/counter/[0-9]+/get/simulation/present_imported$",
                   "^openWB/counter/[0-9]+/get/simulation/present_exported$",
                   "^openWB/counter/[0-9]+/set/consumption_left$",
                   "^openWB/counter/[0-9]+/config/max_current$",
                   ...
                   "^openWB/pv/[0-9]+/get/simulation/timestamp_present$",
                   "^openWB/pv/[0-9]+/get/simulation/power_present$",
                   "^openWB/pv/[0-9]+/get/simulation/present_imported$",
                   "^openWB/pv/[0-9]+/get/simulation/present_exported$",
