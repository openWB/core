...
def pub_settings():
    try:
        ...
        #system
        pub.pub("openWB/set/system/devices/0/config", {"name": "OpenWB-Kit", "type": "openwb_flex", "id": 0, "configuration": {"ip_address": "192.168.1.101", "port": 8899, "id": 105}, 
        "components": {"component0": {"name": "EVU-Kit flex", "type": "counter", "id": 0, "configuration": {"version": 2, "id": 0}}}})
    except Exception as e:
        log.MainLogger().exception("Fehler im publishvars-Modul")