...
def pub_defaults():
    ...
    try:
        ...
        # Ladepunkt-Vorlage
        pub.pub(
            "openWB/defaults/chargepoint/template/0/autolock/1/frequency/selected",
            "daily")
        pub.pub("openWB/defaults/chargepoint/template/0/autolock/1/time",
                ["07:00", "16:15"])
        pub.pub("openWB/defaults/chargepoint/template/0/autolock/1/active",
                True)
        pub.pub(
            "openWB/defaults/chargepoint/template/0/autolock/wait_for_charging_end",
            False)
        ...
        # Allgemeine Module
        pub.pub("openWB/defaults/general/chargemode_config/individual_mode",
                True)
        pub.pub("openWB/defaults/general/chargemode_config/unbalanced_load",
                False)
        pub.pub(
            "openWB/defaults/general/chargemode_config/unbalanced_load_limit",
            18)
        pub.pub(
            "openWB/defaults/general/chargemode_config/instant_charging/phases_to_use",
            3)
        pub.pub(
            "openWB/defaults/general/chargemode_config/pv_charging/bat_prio",
            1)
        pub.pub(
            "openWB/defaults/general/chargemode_config/pv_charging/switch_on_soc",
            60)
        pub.pub(
            "openWB/defaults/general/chargemode_config/pv_charging/switch_off_soc",
            40)
        pub.pub(
            "openWB/defaults/general/chargemode_config/pv_charging/rundown_power",
            1000)
        pub.pub(
            "openWB/defaults/general/chargemode_config/pv_charging/rundown_soc",
            50)
        pub.pub(
            "openWB/defaults/general/chargemode_config/pv_charging/charging_power_reserve",
            200)
        pub.pub(
            "openWB/defaults/general/chargemode_config/pv_charging/control_range",
            [0, 230])
        pub.pub(
            "openWB/defaults/general/chargemode_config/pv_charging/switch_off_threshold",
            5)
        pub.pub(
            "openWB/defaults/general/chargemode_config/pv_charging/switch_off_delay",
            60)
        pub.pub(
            "openWB/defaults/general/chargemode_config/pv_charging/switch_on_delay",
            30)
        pub.pub(
            "openWB/defaults/general/chargemode_config/pv_charging/switch_on_threshold",
            1500)
        pub.pub(
            "openWB/defaults/general/chargemode_config/pv_charging/feed_in_yield",
            15000)
        pub.pub(
            "openWB/defaults/general/chargemode_config/pv_charging/phase_switch_delay",
            15)
        pub.pub(
            "openWB/defaults/general/chargemode_config/pv_charging/phases_to_use",
            0)
        pub.pub(
            "openWB/defaults/general/chargemode_config/scheduled_charging/phases_to_use",
            0)
        pub.pub(
            "openWB/defaults/general/chargemode_config/time_charging/phases_to_use",
            1)
        pub.pub(
            "openWB/defaults/general/chargemode_config/standby/phases_to_use",
            1)
        pub.pub("openWB/defaults/general/chargemode_config/stop/phases_to_use",
                1)
        ...
        pub.pub("openWB/defaults/general/ripple_control_receiver/configured",
                False)
