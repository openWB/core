...
cases = [
    Params("1to3, enough power, start timer", max_current_single_phase=16, timestamp_auto_phase_switch=None,
           ...
           get_power=3450, state=StateMachine.CHARGING_ALLOWED, expected_phases_to_use=1, expected_current=6,
           expected_message="Umschaltverzögerung von 1 auf 3 Phasen für 7.0 Min aktiv.",
           expected_timestamp_auto_phase_switch="05/16/2022, 08:40:52", expected_state=StateMachine.PHASE_SWITCH_DELAY),
    Params("1to3, not enough power, start timer", max_current_single_phase=16, timestamp_auto_phase_switch=None,
           ...
           get_power=3450, state=StateMachine.CHARGING_ALLOWED, expected_phases_to_use=1, expected_current=6,
           expected_state=StateMachine.CHARGING_ALLOWED),
    Params("1to3, enough power, timer not expired", max_current_single_phase=16,
           ...
           state=StateMachine.PHASE_SWITCH_DELAY, expected_phases_to_use=1, expected_current=6,
           expected_message="Umschaltverzögerung von 1 auf 3 Phasen für 7.0 Min aktiv.",
           expected_timestamp_auto_phase_switch="05/16/2022, 08:40:52",
           expected_state=StateMachine.PHASE_SWITCH_DELAY),
    Params("1to3, not enough power, timer not expired", max_current_single_phase=16,
           ...
           expected_timestamp_auto_phase_switch="05/16/2022, 08:40:52", expected_state=StateMachine.CHARGING_ALLOWED),
    Params("1to3, enough power, timer expired", max_current_single_phase=16,
           ...
           evu_get_power=-1200, reserved_evu_overhang=460, get_currents=[15.6, 0, 0], get_power=3450,
           state=StateMachine.PHASE_SWITCH_DELAY,
           expected_phases_to_use=3, expected_current=6, expected_state=StateMachine.PHASE_SWITCH_DELAY_EXPIRED),
    ...
    Params("3to1, not enough power, start timer", max_current_single_phase=16, timestamp_auto_phase_switch=None,
           ...
           get_currents=[4.5, 4.4, 5.8], get_power=3381, state=StateMachine.CHARGING_ALLOWED, expected_phases_to_use=3,
    ...
    Params("3to1, not enough power, timer not expired", max_current_single_phase=16,
           ...
           get_currents=[4.5, 4.4, 5.8], get_power=3381, state=StateMachine.PHASE_SWITCH_DELAY,
    ...
    Params("3to1, enough power, timer not expired", max_current_single_phase=16,
           ...
           get_power=3381, state=StateMachine.PHASE_SWITCH_DELAY, expected_phases_to_use=3, expected_current=6,
           expected_message="Umschaltverzögerung von 3 auf 1 Phasen für 9.0 Min aktiv.",
           expected_timestamp_auto_phase_switch="05/16/2022, 08:40:52",
           expected_state=StateMachine.PHASE_SWITCH_DELAY),
    Params("3to1, not enough power, timer expired", max_current_single_phase=16,
           ...
           get_power=3381, state=StateMachine.PHASE_SWITCH_DELAY, expected_phases_to_use=1, expected_current=16,
           expected_state=StateMachine.PHASE_SWITCH_DELAY_EXPIRED),
]
