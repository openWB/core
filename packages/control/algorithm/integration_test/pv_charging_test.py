...
cases_limit = [
    ParamsSurplus(name="surplus left",
                  ...
                  expected_current_cp3=15.833333333333332,
    ...
    ParamsSurplus(name="reduce current",
                  ...
                  raw_currents_left_counter0=[40]*3,
                  raw_currents_left_counter6=[16]*3,
                  expected_current_cp3=11.170933224976297,
                  expected_current_cp4=7.180294522884857,
                  expected_current_cp5=7.228482397066382,
                  expected_current_consumer7=0.5,
