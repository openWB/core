...
CHARGEMODES = ((Chargemode.SCHEDULED_CHARGING, Chargemode.INSTANT_CHARGING, True),  # 0
               ...
               (Chargemode.INSTANT_CHARGING, Chargemode.BIDI_CHARGING, False),  # 18
               (Chargemode.INSTANT_CHARGING, Chargemode.BIDI_CHARGING, True),  # 19
               (Chargemode.SCHEDULED_CHARGING, Chargemode.BIDI_CHARGING, False),  # 16
               (Chargemode.SCHEDULED_CHARGING, Chargemode.BIDI_CHARGING, True),  # 17
...
CONSIDERED_CHARGE_MODES_ADDITIONAL_CURRENT = CHARGEMODES[0:10]  # + CHARGEMODES[16:20]
CONSIDERED_CHARGE_MODES_MIN_CURRENT = CHARGEMODES[0:-6]  # + CHARGEMODES[16:18]
