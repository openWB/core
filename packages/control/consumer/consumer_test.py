...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            ...
            (11, "ok", Chargemode.PV_CHARGING, False),
            WaitForStartStates.WAIT_FOR_DEVICE_START,
            1,
        ...
        pytest.param(
            ...
            (8, f"{Consumer.DEVICE_WAITING_FOR_START} pv ok", Chargemode.PV_CHARGING, False),
        ...
        pytest.param(
            ...
            (7, "started", Chargemode.INSTANT_CHARGING, False),
        ...
        pytest.param(
            ...
            (10, "continue", Chargemode.PV_CHARGING, False),
            WaitForStartStates.START_SIGNAL_RECEIVED,
            1,
