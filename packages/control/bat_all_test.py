...
cases = [
    ...
    Params(("Mindest-SoC, Hysterese, Speicher lädt, Ladeleistung bleibt beim Speicher"),
           ChargemodeConfigBat(mode="min_soc_bat_mode", power_discharge=500, power_discharge_active=True),
           400, 60, 500, False, hysteresis_discharge=True),
    Params(("Mindest-SoC, Hysterese, Speicher ruht, nur die erlaubte Entladeleistung"),
           ChargemodeConfigBat(mode="min_soc_bat_mode", power_discharge=500, power_discharge_active=True),
           0, 60, 500, False, hysteresis_discharge=True),
    Params(("Mindest-SoC, Hysterese, Speicher entlädt innerhalb der Entladeleistung"),
           ChargemodeConfigBat(mode="min_soc_bat_mode", power_discharge=500, power_discharge_active=True),
           -300, 60, 200, False, hysteresis_discharge=True),
    Params(("Mindest-SoC, Hysterese, Speicher entlädt mehr als die Entladeleistung"),
           ChargemodeConfigBat(mode="min_soc_bat_mode", power_discharge=500, power_discharge_active=True),
           -700, 60, -200, False, hysteresis_discharge=True),
