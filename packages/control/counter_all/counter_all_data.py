...
class LoadmanagementPrioProtocol(Protocol):
    ...
    def update_consumer_loadmanagement_prio(self, consumer_id: int, usage_type: ConsumerUsage) -> bool: ...
    def _has_loadmanagement_prio_item(
        self, type: ComponentType, id: int, entries: List[Dict]) -> bool: ...

    def remove_loadmanagement_prio_item(self, type: ComponentType, id: int) -> None: ...
    def _remove_loadmanagement_prio_item(self, type: ComponentType, id: int, entry: List[Dict]) -> bool: ...
