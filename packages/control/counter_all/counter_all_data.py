...
class LoadmanagementPrioProtocol(Protocol):
    ...
    def remove_loadmanagement_prio_item(self, id: int, type: ComponentType) -> None: ...
    def _remove_loadmanagement_prio_item(self, id: int, type: ComponentType, entry: Dict) -> None: ...
