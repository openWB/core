...
from modules.common.store._battery import get_bat_value_store  # obsolet 2.3.0
...
from modules.common.store._counter import get_counter_value_store  # obsolet 2.3.0
from modules.common.store._factory import get_component_value_store
from modules.common.store._inverter import get_inverter_value_store  # obsolet 2.3.0
