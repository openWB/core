...
from modules.common.hardware_check import (
    EVSE_BROKEN, LAN_ADAPTER_BROKEN, METER_BROKEN, METER_BROKEN_VOLTAGES, METER_PROBLEM, USB_ADAPTER_BROKEN,
...
def test_hardware_check_fails(evse_side_effect,
    ...
    mock_meter_client = Mock(spec=sdm.Sdm630, get_counter_state=Mock(return_value=counter_state_mock))
