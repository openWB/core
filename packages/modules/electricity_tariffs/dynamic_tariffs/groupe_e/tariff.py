...
from modules.electricity_tariffs.dynamic_tariffs.groupe_e.config import GroupeETariffConfiguration
from modules.electricity_tariffs.dynamic_tariffs.groupe_e.config import GroupeETariff
