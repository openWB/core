...
from modules.devices.siemens.siemens.config import SiemensBatSetup
...
class SiemensBat(AbstractBat):
    def __init__(self, component_config: SiemensBatSetup, **kwargs: Any) -> None:
