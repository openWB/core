...
class SofarInverter(AbstractInverter):
    ...
    def update(self) -> None:
        ...
        power = sum([self.client.read_input_registers(reg, ModbusDataType.UINT_16,
        ...
        exported = self.client.read_input_registers(0x0686, ModbusDataType.UINT_32, wordorder=Endian.Little,
