...
class SofarBat(AbstractBat):
    ...
    def update(self) -> None:
        ...
        power = sum(self.client.read_input_registers(reg, ModbusDataType.INT_16, unit=self.__modbus_id)
        ...
        soc = sum(self.client.read_input_registers(0x0608, ModbusDataType.UINT_16, unit=self.__modbus_id)
