...
class SofarBat(AbstractBat):
    ...
    def update(self, client: ModbusTcpClient_) -> None:
        ...
        power = sum(client.read_holding_registers(reg, ModbusDataType.INT_16, unit=self.__modbus_id)
                    for reg in [0x0606, 0x060D, 0x0614, 0x061B, 0x0622, 0x0629, 0x0630,
                                0x0637, 0x0646, 0x064D, 0x0654, 0x065B]) * -10
        ...
        soc = sum(client.read_holding_registers(0x0608, ModbusDataType.UINT_16, unit=self.__modbus_id)
