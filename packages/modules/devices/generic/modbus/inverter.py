...
from modules.devices.generic.modbus.config import GenericModbusInverterSetup, GenericModbusConfiguration
...
class GenericModbusInverter(AbstractInverter):
    ...
    def update(self) -> None:
        ...
        # DC Power
        dc_power_value = read_value(self.client, unit, self.device_configuration, config.dc_power)
