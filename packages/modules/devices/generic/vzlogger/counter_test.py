...
from modules.devices.generic.vzlogger import counter
from modules.devices.generic.vzlogger.config import (VZLogger, VZLoggerConfiguration, VZLoggerCounterConfiguration,
                                                     VZLoggerCounterSetup)
from modules.devices.generic.vzlogger.device import create_device
