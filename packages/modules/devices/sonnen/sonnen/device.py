...
from modules.devices.sonnen.sonnen import bat, counter, inverter
from modules.devices.sonnen.sonnen.config import (SonnenBatterie, SonnenbatterieBatSetup, SonnenbatterieCounterSetup,
