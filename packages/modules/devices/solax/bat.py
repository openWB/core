...
class SolaxBat:
    ...
    def update(self) -> None:
        with self.__tcp_client:
            ...
            imported = self.__tcp_client.read_input_registers(0x001D, ModbusDataType.UINT_16, unit=self.__modbus_id) * 100
            exported = self.__tcp_client.read_input_registers(0x0021, ModbusDataType.UINT_16, unit=self.__modbus_id) * 100
