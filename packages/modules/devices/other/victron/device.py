...
from modules.devices.other.victron import bat
from modules.devices.other.victron import counter
from modules.devices.other.victron import inverter
from modules.devices.other.victron.config import Victron, VictronBatSetup, VictronCounterSetup, VictronInverterSetup
