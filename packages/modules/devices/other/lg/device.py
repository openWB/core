...
from modules.devices.other.lg.config import LG, LgBatSetup, LgConfiguration, LgCounterSetup, LgInverterSetup
from modules.devices.other.lg import bat, counter, inverter
