...
from modules.devices.other.siemens.siemens_sentron import counter
from modules.devices.other.siemens.siemens_sentron.config import SiemensSentron, SiemensSentronCounterSetup
    ...
    def add_component(self, component_config: Union[Dict, SiemensSentronCounterSetup]) -> None:
        ...
        if component_type in self.COMPONENT_TYPE_TO_CLASS:
            self.components["component"+str(component_config.id)] = self.COMPONENT_TYPE_TO_CLASS[component_type](
                component_config, self.client, self.device_config.configuration.modbus_id)
        else:
            raise Exception(
