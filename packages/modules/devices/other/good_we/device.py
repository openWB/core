...
from modules.devices.other.good_we import bat
from modules.devices.other.good_we import counter
from modules.devices.other.good_we import inverter
from modules.devices.other.good_we.config import (GoodWe, GoodWeBatSetup, GoodWeConfiguration, GoodWeCounterSetup,
                                                  GoodWeInverterSetup)
