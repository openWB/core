...
from modules.devices.other.azzurro_sofar.bat import SofarBat
from modules.devices.other.azzurro_sofar.config import Sofar, SofarBatSetup, SofarCounterSetup, SofarInverterSetup
from modules.devices.other.azzurro_sofar.counter import SofarCounter
from modules.devices.other.azzurro_sofar.inverter import SofarInverter
