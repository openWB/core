...
from modules.devices.other.sma.sma_sunny_boy import device
from modules.devices.other.sma.sma_sunny_boy.bat import SunnyBoyBat
from modules.devices.other.sma.sma_sunny_boy.inverter import SmaSunnyBoyInverter
