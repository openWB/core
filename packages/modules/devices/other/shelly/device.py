...
from modules.devices.other.shelly.inverter import ShellyInverter
from modules.devices.other.shelly.config import Shelly, ShellyConfiguration
from modules.devices.other.shelly.config import ShellyInverterSetup, ShellyInverterConfiguration
