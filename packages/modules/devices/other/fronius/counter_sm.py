...
from modules.devices.other.fronius.config import FroniusConfiguration, MeterLocation
from modules.devices.other.fronius.config import FroniusSmCounterSetup
