...
from modules.devices.other.solar.solar_world import counter, inverter
from modules.devices.other.solar.solar_world.config import (
    SolarWorld, SolarWorldConfiguration, SolarWorldCounterSetup, SolarWorldInverterSetup)
from modules.devices.other.solar.solar_world.counter import SolarWorldCounter
from modules.devices.other.solar.solar_world.inverter import SolarWorldInverter
