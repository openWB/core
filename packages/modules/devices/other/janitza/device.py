...
from modules.devices.other.janitza import counter
from modules.devices.other.janitza.config import Janitza, JanitzaCounterSetup
...
class Device(AbstractDevice):
    ...
    def __init__(self, device_config: Union[Dict, Janitza]) -> None:
    ...
    def add_component(self, component_config: Union[Dict, JanitzaCounterSetup]) -> None:
