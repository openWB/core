...
from modules.devices.openwb_flex.config import ConsumptionCounterFlexSetup
from modules.devices.openwb_flex.versions import consumption_counter_factory
