...
from modules.devices.sungrow.sungrow_sh.config import SungrowSHInverterSetup, SungrowSH
...
class SungrowSHInverter(AbstractInverter):
    def __init__(self, component_config: SungrowSHInverterSetup, **kwargs: Any) -> None:
...
component_descriptor = ComponentDescriptor(configuration_factory=SungrowSHInverterSetup)
