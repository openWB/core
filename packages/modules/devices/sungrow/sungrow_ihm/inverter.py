...
from modules.devices.sungrow.sungrow_ihm.config import SungrowIHMInverterSetup, SungrowIHM
...
class SungrowIHMInverter(AbstractInverter):
    def __init__(self, component_config: SungrowIHMInverterSetup, **kwargs: Any) -> None:
...
component_descriptor = ComponentDescriptor(configuration_factory=SungrowIHMInverterSetup)
