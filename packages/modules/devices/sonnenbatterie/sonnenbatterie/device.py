...
from modules.devices.sonnenbatterie.sonnenbatterie import bat, counter, inverter
from modules.devices.sonnenbatterie.sonnenbatterie.config import (SonnenBatterie, SonnenbatterieBatSetup,
