...
from modules.devices.lg.lg.config import LG, LgBatSetup, LgConfiguration, LgCounterSetup, LgInverterSetup
from modules.devices.lg.lg import bat, counter, inverter
