...
class EcoMainRuntime:
    ...
    def read_counter(self) -> EcoMainCounterReading:
        imported = self._read(12, ModbusDataType.UINT_64)
        exported = self._read(28, ModbusDataType.UINT_64)
    ...
    def read_channel(self, source: int, channel: int) -> EcoMainChannelReading:
        ...
        forward_energy = self._read(forward_address, ModbusDataType.UINT_64)
        reverse_energy = self._read(reverse_address, ModbusDataType.UINT_64)
