...
class MTecCounter(AbstractCounter):
    def __init__(self, device_id: int, component_config: MTecCounterSetup, client: ModbusTcpClient_) -> None:
    ...
    def update(self) -> None:
        ...
        power = self.client.read_holding_registers(11000, ModbusDataType.INT_32, unit=unit)
