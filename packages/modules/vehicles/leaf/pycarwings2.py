...
class Session(object):
    ...
    def _request(self, endpoint, params):
        ...
        # ", headers={"User-Agent": ""}" added,
        # see https://github.com/filcole/pycarwings2/blob/master/pycarwings2/pycarwings2.py
        # added parameter is needed, to be able to run pycarwings2.py on a Windows PC with Python 3.12
