...
class pubvars():
    ...
    #     self.pub_float("mqttwizzarddone:-1"", "openWB/")
        ...
        #Zeitladen
        self.client.publish("openWB/vehicle/template/charge_template/2/time_load/active", payload=json.dumps(1), qos=0, retain=True)
        self.client.publish("openWB/vehicle/template/charge_template/2/time_load/1/active", payload=json.dumps(1), qos=0, retain=True)
        self.client.publish("openWB/vehicle/template/charge_template/2/time_load/1/frequency/selected", payload=json.dumps("weekly"), qos=0, retain=True)
        ...
        self.client.publish("openWB/vehicle/template/charge_template/2/time_load/1/time", payload=json.dumps(["08:00", "11:20"]), qos=0, retain=True)
        ...
        self.client.publish("openWB/vehicle/template/charge_template/2/chargemode/pv_load/max_soc", payload=json.dumps(80), qos=0, retain=True)
        self.client.publish("openWB/vehicle/template/charge_template/2/chargemode/pv_load/bat_prio", payload=json.dumps(0), qos=0, retain=True)
        self.client.publish("openWB/vehicle/template/charge_template/2/chargemode/pv_load/feed_in_limit", payload=json.dumps(0), qos=0, retain=True)
        self.client.publish("openWB/vehicle/template/charge_template/2/prio", payload=json.dumps(1), qos=0, retain=True)
        self.client.publish("openWB/vehicle/template/charge_template/2/chargemode/instant_load/current", payload=json.dumps(12), qos=0, retain=True)
        self.client.publish("openWB/vehicle/template/charge_template/2/chargemode/instant_load/limit/selected", payload=json.dumps("soc"), qos=0, retain=True)
        self.client.publish("openWB/vehicle/template/charge_template/2/chargemode/instant_load/limit/soc", payload=json.dumps(50), qos=0, retain=True)
        self.client.publish("openWB/vehicle/template/charge_template/2/chargemode/instant_load/limit/amount", payload=json.dumps(10), qos=0, retain=True)
        ...
        self.client.publish("openWB/vehicle/template/charge_template/1/chargemode/instant_load/current", payload=json.dumps(11), qos=0, retain=True)
        ...
        self.client.publish("openWB/general/chargemode_config/pv_load/phases_to_use", payload=json.dumps(1), qos=0, retain=True)
        self.client.publish("openWB/general/chargemode_config/scheduled_load/phases_to_use", payload=json.dumps(1), qos=0, retain=True)
        self.client.publish("openWB/general/chargemode_config/time_load/phases_to_use", payload=json.dumps(1), qos=0, retain=True)
