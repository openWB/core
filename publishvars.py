...
class pubvars():
    ...
    #     self.pub_float("mqttwizzarddone:-1"", "openWB/")
        ...
        # cpt2
        self.client.publish("openWB/chargepoint/template/2/autolock/1/frequency/selected", payload=json.dumps("daily"), qos=0, retain=True)
        self.client.publish("openWB/chargepoint/template/2/autolock/1/time", payload=json.dumps(["07:00", "11:20"]), qos=0, retain=True)
        self.client.publish("openWB/chargepoint/template/2/autolock/1/active", payload=json.dumps(0), qos=0, retain=True)
        self.client.publish("openWB/chargepoint/template/2/autolock/wait_for_charging_end", payload=json.dumps(1), qos=0, retain=True)
        self.client.publish("openWB/chargepoint/template/2/autolock/active", payload=json.dumps(0), qos=0, retain=True)
        self.client.publish("openWB/chargepoint/template/2/ev", payload=json.dumps(2), qos=0, retain=True)
        self.client.publish("openWB/chargepoint/template/2/rfid_enabling", payload=json.dumps(0), qos=0, retain=True)
        #cp1
        ...
        self.client.publish("openWB/vehicle/1/get/soc", payload=json.dumps(25), qos=0, retain=True)
        ...
        #ev2
        self.client.publish("openWB/vehicle/2/charge_template", payload=json.dumps(2), qos=0, retain=True)
        self.client.publish("openWB/vehicle/2/ev_template", payload=json.dumps(1), qos=0, retain=True)
        self.client.publish("openWB/vehicle/2/name", payload=json.dumps("car2"), qos=0, retain=True)
        self.client.publish("openWB/vehicle/2/get/soc", payload=json.dumps(24), qos=0, retain=True)
        self.client.publish("openWB/vehicle/2/get/charged_since_plugged_kwh", payload=json.dumps(5), qos=0, retain=True)
        self.client.publish("openWB/vehicle/2/match_ev/selected", payload=json.dumps("rfid"), qos=0, retain=True)
        self.client.publish("openWB/vehicle/2/match_ev/tag_id", payload=json.dumps(1234), qos=0, retain=True)

        #ct2
        self.client.publish("openWB/vehicle/template/charge_template/2/time_charging/active", payload=json.dumps(0), qos=0, retain=True)
        self.client.publish("openWB/vehicle/template/charge_template/2/time_charging/1/active", payload=json.dumps(1), qos=0, retain=True)
        self.client.publish("openWB/vehicle/template/charge_template/2/time_charging/1/frequency/selected", payload=json.dumps("weekly"), qos=0, retain=True)
        self.client.publish("openWB/vehicle/template/charge_template/2/time_charging/1/frequency/weekly", payload=json.dumps([1,1,1,1,1,0,0]), qos=0, retain=True)
        self.client.publish("openWB/vehicle/template/charge_template/2/time_charging/1/time", payload=json.dumps(["08:00", "11:20"]), qos=0, retain=True)
        self.client.publish("openWB/vehicle/template/charge_template/2/time_charging/1/current", payload=json.dumps(10), qos=0, retain=True)
        self.client.publish("openWB/vehicle/template/charge_template/2/chargemode/selected", payload=json.dumps("instant_charging"), qos=0, retain=True)
        self.client.publish("openWB/vehicle/template/charge_template/2/chargemode/pv_charging/min_current", payload=json.dumps(12), qos=0, retain=True)
        self.client.publish("openWB/vehicle/template/charge_template/2/chargemode/pv_charging/min_soc", payload=json.dumps(23), qos=0, retain=True)
        ...
        self.client.publish("openWB/vehicle/template/charge_template/2/chargemode/instant_charging/limit/soc", payload=json.dumps(50), qos=0, retain=True)
        self.client.publish("openWB/vehicle/template/charge_template/2/chargemode/instant_charging/limit/amount", payload=json.dumps(10), qos=0, retain=True)

        #ct1
        self.client.publish("openWB/vehicle/template/charge_template/1/time_charging/active", payload=json.dumps(0), qos=0, retain=True)
        ...
        self.client.publish("openWB/vehicle/template/charge_template/1/chargemode/instant_charging/current", payload=json.dumps(11), qos=0, retain=True)
        self.client.publish("openWB/vehicle/template/charge_template/1/chargemode/instant_charging/limit/selected", payload=json.dumps("soc"), qos=0, retain=True)
        self.client.publish("openWB/vehicle/template/charge_template/1/chargemode/instant_charging/limit/soc", payload=json.dumps(50), qos=0, retain=True)
        self.client.publish("openWB/vehicle/template/charge_template/1/chargemode/instant_charging/limit/amount", payload=json.dumps(10), qos=0, retain=True)
        self.client.publish("openWB/vehicle/template/charge_template/1/chargemode/pv_charging/min_current", payload=json.dumps(10), qos=0, retain=True)
        self.client.publish("openWB/vehicle/template/charge_template/1/chargemode/pv_charging/min_soc", payload=json.dumps(23), qos=0, retain=True)
        ...
        # self.client.publish("openWB/vehicle/template/charge_template/1/chargemode/pv_charging/max_soc", payload=json.dumps(80), qos=0, retain=True)
        #scheduled_charging
        # self.client.publish("openWB/vehicle/template/charge_template/2/chargemode/selected", payload=json.dumps("scheduled_charging"), qos=0, retain=True)
        # self.client.publish("openWB/vehicle/template/charge_template/2/time_charging/active", payload=json.dumps(0), qos=0, retain=True)
        # self.client.publish("openWB/vehicle/template/charge_template/2/chargemode/scheduled_charging/1/active", payload=json.dumps(1), qos=0, retain=True)
        # self.client.publish("openWB/vehicle/template/charge_template/2/chargemode/scheduled_charging/1/frequency/selected", payload=json.dumps("daily"), qos=0, retain=True)
        # self.client.publish("openWB/vehicle/template/charge_template/2/chargemode/scheduled_charging/1/time", payload=json.dumps("15:00"), qos=0, retain=True)
        # self.client.publish("openWB/vehicle/template/charge_template/2/chargemode/scheduled_charging/1/soc", payload=json.dumps(85), qos=0, retain=True)

        #chargemode_config
        self.client.publish("openWB/general/chargemode_config/scheduled_charging/phases_to_use", payload=json.dumps(3), qos=0, retain=True)
        ...
        self.client.publish("openWB/counter/0/get/current", payload=json.dumps([5,5,5]), qos=0, retain=True)
        self.client.publish("openWB/counter/0/config/max_consumption", payload=json.dumps(6000), qos=0, retain=True)
        self.client.publish("openWB/counter/0/config/max_current", payload=json.dumps([35, 35, 35]), qos=0, retain=True)
        ...
        self.client.publish("openWB/general/chargemode_config/pv_charging/switch_off_soc", payload=json.dumps(40), qos=0, retain=True)
        self.client.publish("openWB/general/chargemode_config/pv_charging/rundown_power", payload=json.dumps(1400), qos=0, retain=True)
        self.client.publish("openWB/general/chargemode_config/pv_charging/rundown_soc", payload=json.dumps(100), qos=0, retain=True)
        ...
        self.client.publish("openWB/general/chargemode_config/standby/phases_to_use", payload=json.dumps(1), qos=0, retain=True)
        self.client.publish("openWB/general/chargemode_config/stop/phases_to_use", payload=json.dumps(0), qos=0, retain=True)
