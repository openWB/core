...
livegraph=$1
echo "$(tail -$livegraph ${RAMDISKDIR}/graph_live.json)" > ${RAMDISKDIR}/graph_live.json
mosquitto_pub -p 1886 -t openWB/graph/alllivevaluesJson -r -m "$(cat ${RAMDISKDIR}/graph_live.json | tail -n 50)" &
mosquitto_pub -p 1886 -t openWB/graph/alllivevaluesJson1 -r -m "$(< ${RAMDISKDIR}/graph_live.json tail -n +"0" | head -n "$((50 - 0))")" &
all2livevalues=$(< ${RAMDISKDIR}/graph_live.json tail -n +"50" | head -n "$((100 - 50))")
all3livevalues="$(< ${RAMDISKDIR}/graph_live.json tail -n +"100" | head -n "$((150 - 100))")"
all4livevalues="$(< ${RAMDISKDIR}/graph_live.json tail -n +"150" | head -n "$((200 - 150))")"
all5livevalues="$(< ${RAMDISKDIR}/graph_live.json tail -n +"200" | head -n "$((250 - 200))")"
all6livevalues="$(< ${RAMDISKDIR}/graph_live.json tail -n +"250" | head -n "$((300 - 250))")"
all7livevalues="$(< ${RAMDISKDIR}/graph_live.json tail -n +"300" | head -n "$((350 - 300))")"
all8livevalues="$(< ${RAMDISKDIR}/graph_live.json tail -n +"350" | head -n "$((400 - 350))")"
all9livevalues="$(< ${RAMDISKDIR}/graph_live.json tail -n +"400" | head -n "$((450 - 400))")"
all10livevalues="$(< ${RAMDISKDIR}/graph_live.json tail -n +"450" | head -n "$((500 - 450))")"
all11livevalues="$(< ${RAMDISKDIR}/graph_live.json tail -n +"500" | head -n "$((550 - 500))")"
all12livevalues="$(< ${RAMDISKDIR}/graph_live.json tail -n +"550" | head -n "$((600 - 550))")"
all13livevalues="$(< ${RAMDISKDIR}/graph_live.json tail -n +"600" | head -n "$((650 - 600))")"
all14livevalues="$(< ${RAMDISKDIR}/graph_live.json tail -n +"650" | head -n "$((700 - 650))")"
all15livevalues="$(< ${RAMDISKDIR}/graph_live.json tail -n +"700" | head -n "$((750 - 700))")"
all16livevalues="$(< ${RAMDISKDIR}/graph_live.json tail -n +"750" | head -n "$((800 - 750))")"
