...
ll=$(timeout 1 mosquitto_sub -h 192.168.1.221 -t 'openWB/lp/1/W')
mosquitto_pub -r -t "openWB/set/chargepoint/1/get/power_all" -m "$ll"
plug=$(timeout 1 mosquitto_sub -h 192.168.1.221 -t 'openWB/lp/1/boolPlugStat')
mosquitto_pub -r -t "openWB/set/chargepoint/1/get/plug_state" -m "$plug"
charge=$(timeout 1 mosquitto_sub -h 192.168.1.221 -t 'openWB/lp/1/boolChargeStat')
mosquitto_pub -r -t "openWB/set/chargepoint/1/get/charge_state" -m "$charge"
current_p1=$(timeout 1 mosquitto_sub -h 192.168.1.221 -t 'openWB/lp/1/APhase1')
current_p2=$(timeout 1 mosquitto_sub -h 192.168.1.221 -t 'openWB/lp/1/APhase2')
current_p3=$(timeout 1 mosquitto_sub -h 192.168.1.221 -t 'openWB/lp/1/APhase3')
mosquitto_pub -r -t "openWB/set/chargepoint/1/get/current" -m "[$current_p1,$current_p2,$current_p3]"
phases_in_use=$(timeout 1 mosquitto_sub -h 192.168.1.221 -t 'openWB/lp/1/countPhasesInUse')
